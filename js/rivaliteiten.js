  ...
  el.innerHTML = rivals.map(club => {
    ...
    if (!h2h.played) {
      return `<div class="card mb-12">
        <div class="card-title" style="display:flex;align-items:center;gap:6px">${clubLogoHTML(club,30)}🔥 ${club.name}</div>
    ...
    return `<div class="card mb-12" style="cursor:pointer" onclick="navigateToClubComparison('${club.id}')">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
        <div class="card-title" style="margin:0;display:flex;align-items:center;gap:6px">${clubLogoHTML(club,30)}🔥 ${club.name}</div>
