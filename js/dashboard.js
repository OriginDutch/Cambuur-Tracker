    ...
    nextMatchHtml=`<div class="card" style="${isRival?'border-left:3px solid var(--rival-accent)':''}" >
      ...
      <div style="text-align:center;padding:8px 0 4px">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:8px">
          <span style="font-weight:700;font-size:16px;text-align:right;flex:1;display:flex;align-items:center;justify-content:flex-end;gap:8px;${hc?.isOwnClub?'color:var(--accent-primary)':''}"><span>${hn}</span>${clubLogoHTML(hc,22)}</span>
          ...
          <span style="font-weight:700;font-size:16px;text-align:left;flex:1;display:flex;align-items:center;justify-content:flex-start;gap:8px;${ac?.isOwnClub?'color:var(--accent-primary)':''}">${clubLogoHTML(ac,22)}<span>${an}</span></span>
        </div>
    ...
    lastMatchHtml=`<div class="card" style="border-left:3px solid ${rc}">
      ...
      <div style="text-align:center;padding:4px 0">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:12px">
          <span style="font-weight:700;font-size:14px;flex:1;text-align:right;display:flex;align-items:center;justify-content:flex-end;gap:6px;${hc?.isOwnClub?'color:var(--accent-primary)':''}"><span>${hn}</span>${clubLogoHTML(hc,18)}</span>
          ...
          <span style="font-weight:700;font-size:14px;flex:1;text-align:left;display:flex;align-items:center;justify-content:flex-start;gap:6px;${ac?.isOwnClub?'color:var(--accent-primary)':''}">${clubLogoHTML(ac,18)}<span>${an}</span></span>
        </div>
