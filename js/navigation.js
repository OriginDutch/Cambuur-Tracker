...
function navigate(page,el){
  ...
  const titles={dashboard:'Dashboard',competitions:'Competities beheren',clubs:'Clubs & Stadions',selectie:'Selectie',statistieken:'Statistieken',vergelijking:'Vergelijking',instellingen:'Instellingen',coaches:'Technische Staf',records:'Clubrecords',rivaliteiten:'Rivaliteiten',dagboek:'Wedstrijddagboek',kalender:'Kalender'};
  ...
  if(page==='kalender'){renderKalenderPage();}
}
